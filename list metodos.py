...
#copy serve pra copiar a lista original 
...
#map()
# aplicar uma função para cada item de uma função

entrada = "1 2 3 4"
lista_de_strings = entrada.split()  # ['1', '2', '3', '4']

lista_de_inteiros = list(map(int, lista_de_strings))  # [1, 2, 3, 4]
